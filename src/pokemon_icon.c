...
const u8 *const gMonIconTable[] =
{
    ...
    [SPECIES_EXEGGCUTE_SCHOOL] = gMonIcon_ExeggcuteSchool,
    [SPECIES_GOLEM_SHIELDS] = gMonIcon_GolemShields,
    [SPECIES_SUDOWOODO_BROKEN] = gMonIcon_SudowoodoBroken,
    ...
    [SPECIES_MEGROWTH] = gMonIcon_Megrowth,
...
const u8 gMonIconPaletteIndices[] =
{
    ...
    [SPECIES_LEAFEON] = 1,
    [SPECIES_GLACEON] = 2,
    [SPECIES_EXEGGCUTE_SCHOOL] = 0,
    [SPECIES_GOLEM_SHIELDS] = 1,
    [SPECIES_SUDOWOODO_BROKEN] = 1,
    [SPECIES_BONSLY] = 1,
    [SPECIES_MIMEJR] = 0,
    [SPECIES_HAPPINY] = 0,
    [SPECIES_WEAVILE] = 0,
