...
s32 CalcCritChanceStage(u8 battlerAtk, u8 battlerDef, u32 move, bool32 recordAbility)
{
    ...
    else if (abilityDef == ABILITY_BATTLE_ARMOR || abilityDef == ABILITY_SHELL_ARMOR || abilityDef == ABILITY_FRIEND_GUARD)
    {
        if (recordAbility)
        ...
        critChance = -1;
             ...
             || (abilityAtk == ABILITY_STRONG_JAW && gBattleMoves[move].flags & FLAG_STRONG_JAW_BOOST))
    {
        critChance = -2;
    }
    else
...
static void Cmd_datahpupdate(void)
{
    ...
    if (!(gMoveResultFlags & MOVE_RESULT_NO_EFFECT))
    {
        ...
        {
            gBattleMons[gActiveBattler].species = SPECIES_SUDOWOODO_BROKEN;
    ...
    else
    {
        ...
        else
        {
            ...
            case MOVE_EFFECT_ATK_DEF_DOWN: // SuperPower
                ...
                break;
            case MOVE_EFFECT_SPD_ATK_UP: // Candy Crunch
                BattleScriptPush(gBattlescriptCurrInstr + 1);
                gBattlescriptCurrInstr = BattleScript_SpdAtkUp;
                break;
...
bool32 DoesDisguiseBlockMove(u8 battlerAtk, u8 battlerDef, u32 move)
{
    if (GetBattlerAbility(battlerDef) != ABILITY_DISGUISE
        || gBattleMons[battlerDef].species != SPECIES_SUDOWOODO
