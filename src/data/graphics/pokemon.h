...
const u32 gMonStillFrontPic_GolemShields[] = INCBIN_U32("graphics/pokemon/golem/shieldsdown/front_shieldsdown.4bpp.lz");
const u32 gMonPalette_GolemShields[] = INCBIN_U32("graphics/pokemon/golem/shieldsdown/normal_shieldsdown.gbapal.lz");
const u32 gMonBackPic_GolemShields[] = INCBIN_U32("graphics/pokemon/golem/shieldsdown/back_shieldsdown.4bpp.lz");
