...
// Altered Emerald mons
    ...
    SPECIES_SPRITE(GOLEM_SHIELDS, gMonFrontPic_GolemShields),
    SPECIES_SPRITE(SUDOWOODO_BROKEN, gMonFrontPic_SudowoodoBroken),
    ...
    SPECIES_SPRITE(MEGROWTH, gMonFrontPic_Megrowth),
