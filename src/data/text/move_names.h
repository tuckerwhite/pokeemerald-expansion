const u8 gMoveNames[MOVES_COUNT][MOVE_NAME_LENGTH + 1] =
{
    ...
    [MOVE_ARMOR_BREAK] = _("Armor Break"),
    ...
    [MOVE_SUPER_SPITUP] = _("Super Spitup"),
    [MOVE_CANDY_CRUNCH] = _("Candy Crunch"),
    [MOVE_SNOW_IN] = _("Snow In"),
    [MOVE_ELECTROPLATE] = _("Electroplate"),
    [MOVE_COAL_TOSS] = _("Coal Toss"),
    [MOVE_BROIL] = _("Broil"),
    [MOVE_CONSTELLATE] = _("Constellate"),
