...
static const u8 sTankShellDescription[] = _("Restores HP. More in rain.");
static const u8 sHydrolyzeDescription[] = _("Turns Normal moves to Water.");
static const u8 sGravitateDescription[] = _("Sets Gravity on entry.");
static const u8 sArmorTuningDescription[] = _("Tunes armor to match foe.");
...
const u8 gAbilityNames[ABILITIES_COUNT_GEN8][ABILITY_NAME_LENGTH + 1] =
{
    ...
    [ABILITY_AIM_ASSIST] = _("Aim Assist"),
    [ABILITY_JET_STREAM] = _("Jet Stream"),
    ...
    [ABILITY_HEAVY_METAL] = _("Dietician"),
    ...
    [ABILITY_TANGLING_HAIR] = _("Tangle"),
...
const u8 *const gAbilityDescriptionPointers[ABILITIES_COUNT_GEN8] =
{
    ...
    [ABILITY_AIM_ASSIST] = sAimAssistDescription,
    [ABILITY_JET_STREAM] = sJetStreamDescription,
