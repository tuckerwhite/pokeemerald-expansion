const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_MEOWTH]     = {{EVO_LEVEL, 28, SPECIES_PERSIAN},
                            {EVO_ITEM, ITEM_ODD_INCENSE, SPECIES_MEGROWTH}},
    ...
    [SPECIES_SLOWPOKE]   = {{EVO_LEVEL_ATK_GT_DEF, 37, SPECIES_SLOWKING},
    ...
    [SPECIES_GASTLY]     = {{EVO_LEVEL, 30, SPECIES_HAUNTER}},
    [SPECIES_HAUNTER]    = {{EVO_FRIENDSHIP_NIGHT, 0, SPECIES_GENGAR}},
    [SPECIES_ONIX]       = {{EVO_LEVEL, 39, SPECIES_STEELIX}},
    ...
    [SPECIES_SCYTHER]    = {{EVO_LEVEL, 39, SPECIES_SCIZOR}},
    ...
    [SPECIES_PORYGON2]    = {{EVO_LEVEL, 23, SPECIES_PORYGON},
                            {EVO_LEVEL, 45, SPECIES_PORYGON_Z}},
    [SPECIES_PORYGON_Z]    = {{EVO_LEVEL, 46, SPECIES_PORYGON},
                            {EVO_LEVEL, 47, SPECIES_PORYGON2}},
    ...
    [SPECIES_NATU]       = {{EVO_LEVEL, 33, SPECIES_XATU}},
    ...
    [SPECIES_POOCHYENA]  = {{EVO_LEVEL, 13, SPECIES_MIGHTYENA}},
    [SPECIES_ZIGZAGOON]  = {{EVO_LEVEL, 20, SPECIES_LINOONE}},
    [SPECIES_WURMPLE]    = {{EVO_LEVEL_ATK_GT_DEF, 7, SPECIES_SILCOON},
                            {EVO_LEVEL_ATK_LT_DEF, 7, SPECIES_CASCOON}},
